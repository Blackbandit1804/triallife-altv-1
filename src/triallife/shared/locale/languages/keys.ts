export const LOCALE_KEYS = {
    ...
    COMMAND_ACCEPT_UNCONSCIOUS: `command-accept-unconscious`,
    ...
    CANNOT_PERFORM_WHILE_UNCONSCIOUS: `cannot-perform-while-unconscious`,
    ...
    PLAYER_IS_NOT_UNCONSCIOUS: `player-is-not-unconscious`,
