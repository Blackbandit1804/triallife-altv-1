...
import { defaultOptions, DiscordID, Options } from '../interfaces/options';
...
export class OptionsController {
    ...
    static async propagateOptions() {
        ...
        if (DefaultConfig.WHITELIST) Logger.info(`Whitelisted Users: ${OptionsController.data.whitelist.length}`);
    }
