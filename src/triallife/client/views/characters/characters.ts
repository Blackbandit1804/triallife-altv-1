...
import { ViewCharacters } from '../../../shared/enums/views';
...
alt.onServer(ViewCharacters.Show, handleView);
alt.onServer(ViewCharacters.Done, handleDone);
...
async function handleSelect(id) {
    ...
    alt.emitServer(ViewCharacters.Select, id);
}

function handleNew() {
    alt.emitServer(ViewCharacters.New);
}
...
function handleDelete(id) {
    alt.emitServer(ViewCharacters.Delete, id);
}
