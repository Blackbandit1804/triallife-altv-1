...
export class InventoryController {
    ...
    static handleProcess(selectedSlot, endSlot, page, hash): void {
        alt.emitServer(ViewInventory.Process, selectedSlot, endSlot, page, hash);
    }

    static handlePickup(hash: string) {
        alt.emitServer(ViewInventory.Pickup, hash);
    }
    ...
    static handleUse(selectedSlot: string, tab: number): void {
        alt.emitServer(ViewInventory.Use, selectedSlot, tab);
    }

    static handleSplit(selectedSlot: string, tab: number, amount: number): void {
        alt.emitServer(ViewInventory.Split, selectedSlot, tab, amount);
    }
