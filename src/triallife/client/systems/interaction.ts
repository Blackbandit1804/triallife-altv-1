...
export class InteractionController {
    ...
    static handleInteractionMode() {
        ...
        if (alt.Player.local.closestInteraction && alt.Player.local.closestInteraction.position) {
            ...
            HelpController.updateHelpText(alt.Player.local.closestInteraction.position, KEY_BINDS.INTERACT, alt.Player.local.closestInteraction.text, null);
        } else if (alt.Player.local.otherInteraction) {
            HelpController.updateHelpText(alt.Player.local.otherInteraction.position, null, alt.Player.local.otherInteraction.short, alt.Player.local.otherInteraction.long);
        }
