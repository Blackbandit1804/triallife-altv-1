...
alt.onServer(SystemEvent.PLAYER_EMIT_ANIMATION, playAnimation);
 ...
 * @param {AnimationFlag} [flags=AnimationFlag.CANCELABLE] A combination of flags. ie. (AnimationFlag.CANCELABLE | AnimationFlag.UPPERBODY_ONLY)
