...
class ObjectiveController {
    ...
    private static getVector3Range() {
        return new alt.Vector3(ObjectiveController.objective.range, ObjectiveController.objective.range, ObjectiveController.objective.range);
    }
    ...
    private static verifyObjective() {
        ...
        if (ObjectiveController.objective.textLabel && dist <= ObjectiveController.objective.range * 10) {
            drawText3D(ObjectiveController.objective.textLabel.data, ObjectiveController.objective.textLabel.pos as alt.Vector3, 0.4, new alt.RGBA(255, 255, 255, 255));
        }
        ...
        if (ObjectiveController.objective.captureProgress >= 1 && dist <= ObjectiveController.objective.range * 10) {
            ...
            drawText3D(progressText, ObjectiveController.objective.pos as alt.Vector3, 0.4, new alt.RGBA(255, 255, 255, 255));
        }
