...
import { EconomyTypes, PhoneEvents, SYSTEM_EVENTS } from '../../shared/utility/enums';
...
function handleDeposit(player: alt.Player, amount: number): boolean {
    ...
    playerFuncs.currency.sub(player, EconomyTypes.CASH, amount);
    playerFuncs.currency.add(player, EconomyTypes.BANK, amount);
...
function handleWithdraw(player: alt.Player, amount: number): boolean {
    ...
    playerFuncs.currency.sub(player, EconomyTypes.BANK, amount);
    playerFuncs.currency.add(player, EconomyTypes.CASH, amount);
...
function handleTransfer(player: alt.Player, amount: number, id: string | number): boolean {
    ...
    playerFuncs.currency.sub(player, EconomyTypes.BANK, amount);
    playerFuncs.currency.add(target, EconomyTypes.BANK, amount);
...
function handleTransferCash(player: alt.Player, amount: number, id: string | number): boolean {
    ...
    playerFuncs.currency.sub(player, EconomyTypes.CASH, amount);
    playerFuncs.currency.add(target, EconomyTypes.CASH, amount);
