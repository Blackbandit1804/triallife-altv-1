...
export default {
    ...
    [LOCALE_KEYS.WEBVIEW_INVENTORY]: {
        ITEM_SLOTS: ['Hut', 'Maske', 'Oberteil', 'Hose', 'Schuhe', 'Brille', 'Ohren', 'Tasche', 'Panzerung', 'Uhr', 'Armband'],
        LABEL_SPLIT: 'Teilen',
    ...
    [LOCALE_KEYS.WEBVIEW_CLOTHING]: {
        ...
        LABEL_EARRINGS: 'Ohrringe / Hörer',
        LABEL_BAG: 'Tasche / Rucksack',
        LABEL_ARMOUR: 'Panzerung',
        LABEL_WATCH: 'Armbanduhr',
        LABEL_BRACELET: 'Armband',
        LABEL_TOP: 'Jacke',
