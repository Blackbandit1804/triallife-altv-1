...
const app = new Vue({
    ...
    data() {
        return {
            ...
            locales: {
                LABEL_HAT: 'Hüte',
                LABEL_SHIRT: 'Oberteile',
                LABEL_MASK: 'Masken',
                LABEL_BOTTOMS: 'Hosen',
                LABEL_SHOES: 'Schuhe',
                LABEL_GLASSES: 'Brillen',
                LABEL_EARRINGS: 'Ohrringe / Ohrstücke',
                LABEL_BAG: 'Taschen / Rucksäcke',
                LABEL_ARMOUR: 'Panzerungen',
                LABEL_WATCH: 'Armbanduhren',
                LABEL_BRACELET: 'Kettchen',
                LABEL_TOP: 'Shirt Top',
                LABEL_UNDERSHIRT: 'Unterhemnd',
    ...
    methods: {
        incrementComponent(index, dataName) {
            ...
            if ('alt' in window) alt.emit('play:Sound', 'TOGGLE_ON', 'HUD_FRONTEND_DEFAULT_SOUNDSET');
        ...
        decrementComponent(index, dataName) {
            const newComponents = [...this.components];
            newComponents[this.componentIndex][dataName][index] -= 1;
            if (dataName === 'drawables') newComponents[this.componentIndex].textures[index] = 0;
            if (dataName === 'drawables') {
                const maxValue = newComponents[this.componentIndex].maxDrawables[index];
        ...
        updateLocales() {
            ...
            this.components = [
                { name: this.locales.LABEL_HAT, ids: [0], drawables: [0], textures: [0], maxDrawables: [0], maxTextures: [0], isProp: true },
                { name: this.locales.LABEL_MASK, ids: [1], drawables: [0], textures: [0], maxDrawables: [0], maxTextures: [0], isProp: false },
                {
                ...
                { name: this.locales.LABEL_BOTTOMS, ids: [4], drawables: [0], textures: [0], maxDrawables: [0], maxTextures: [0], isProp: false },
                { name: this.locales.LABEL_SHOES, ids: [6], drawables: [0], textures: [0], maxDrawables: [0], maxTextures: [0], isProp: false },
                { name: this.locales.LABEL_GLASSES, ids: [1], drawables: [0], textures: [0], maxDrawables: [0], maxTextures: [0], isProp: true },
                { name: this.locales.LABEL_EARRINGS, ids: [2], drawables: [0], textures: [0], maxDrawables: [0], maxTextures: [0], isProp: true },
                { name: this.locales.LABEL_BAG, ids: [5], drawables: [0], textures: [0], maxDrawables: [0], maxTextures: [0], isProp: false },
                { name: this.locales.LABEL_ARMOUR, ids: [9], drawables: [0], textures: [0], maxDrawables: [0], maxTextures: [0], isProp: false },
                { name: this.locales.LABEL_WATCH, ids: [6], drawables: [0], textures: [0], maxDrawables: [0], maxTextures: [0], isProp: true },
                { name: this.locales.LABEL_BRACELET, ids: [7], drawables: [0], textures: [0], maxDrawables: [0], maxTextures: [0], isProp: true }
            ];
        }
    },
    watch: {
        name(value) {
            ...
            this.name = value;
            if (plainText.test(this.name)) this.nameValid = true;
            if (plainTextDesc.test(this.desc)) this.descValid = true;
